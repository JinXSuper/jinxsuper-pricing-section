...
export const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      uniforms.uTime.value = timeOffset + elapsed * speed;
  ...
  }, [antialias, pixelSize, color, patternScale, patternDensity, pixelSizeJitter,
      enableRipples, rippleIntensityScale, rippleThickness, rippleSpeed,
      speed, transparent, edgeFade, variant]);
